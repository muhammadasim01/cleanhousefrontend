    ...
    <>
      ...
      <div className=" p-4">
        ...
        <p className="font-text text-lg font-normal leading-6">
          ...
          you are available on a regular basis. Explain the days and times you
          are available.
        </p>
        <div className="my-2">
          <input
        ...
        <p className="font-text text-lg font-normal leading-6">
          (The more services you can offer, the more you will be booked for
          jobs. Please click only if you have more than 3 months experience for
          each service. Click <span className="text-secondaryColor">here</span>{" "}
        ...
        <p className="font-text text-lg font-normal leading-6">
          ...
          amount you want to earn by increasing it by 25%. Example: if you want
          to earn $20 per hour, add 25% extra to $25 per hour. This will cover
          our fees.{" "}
        </p>
        <div className="my-2">
        ...
        <p className="font-text text-lg font-norml text-darkColor leading-6">
          ...
          same days and at the same time. If you are wanting to work full time,
          we suggest starting as early as possible like 8am.{" "}
        </p>
        ...
        <p className="font-text text-lg font-normal leading-6">
          This will be your profile photo. Use a well lit clear photo of you
          face without sunglasses. Center your face and smile.{" "}
        </p>
