  ...
  return (
    <div className=" bg-primaryColor flex flex-col items-center justify-center p-5 sm:flex-row sm:h-[450px] md:[550px]">
      <div className="sm:h-[430px] sm:flex sm:flex-col  sm:justify-center sm:items-center sm:w-[50%] md:my-40 lg:px-14">
        <h2 className="text-center font-subHeading text-[44px] leading-[120%] font-bold text-lightColor p-3 md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl">
          How to contact your cleaner
        </h2>
        <p className="text-[22px] font-light text-center leading-[140%] text-lightColor sm:text-center md:px-10 lg:text-base">
        ...
        <div className="text-center p-5">
          <button className="text-center mt-2 font-text text-[16px] w-[179px] h-[35px] font-extrabold text-secondaryColor bg-lightColor py-1  rounded-md">
