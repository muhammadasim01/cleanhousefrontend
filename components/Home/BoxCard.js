...
function BoxCard({
  ...
  return (
    <div
      className={`flex bg-lightColor my-4 py-5 px-2 h-58 w-[18rem] rounded-[8px]  items-start justify-center shadow-[-10px_1px_20px_15px_rgba(0,0,0,0.1)]
    ...
    >
      ...
      <div className="w-[70%] md:h-[70%] lg:h-[70%] flex flex-col items-start">
        <div>
