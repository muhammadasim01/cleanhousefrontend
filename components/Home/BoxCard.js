...
function BoxCard({
  ...
  return (
    <div
      className={`flex bg-lightColor my-4 py-5 px-2 h-58 
      w-[18rem] rounded-[8px] flex-row justify-center shadow-[-10px_1px_20px_15px_rgba(0,0,0,0.1)]
       ...
       `}
    >
      <div className="w-[30%] flex items-start mt-5 mr-2">
