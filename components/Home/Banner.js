...
const Banner = () => {
  ...
  return (
    <>
      <div className="bg-[url('../public/assets/Mobile-Banner.png')] bg-top sm:bg-center bg-no-repeat h-[650px] w-[100%] bg-cover  sm:h-[780px]  md:h-[700px] md:bg-center lg:bg-cover xl:bg:contain 2xl:bg:contain xl-h-[500px] 2xl:h-[800px]">
          ...
          <div className="flex flex-col  w-[100%]">
            ...
            <form className="flex relative items-center justify-center w-full pl-7 sm:w-[600px] ">
              <input
                ...
                className="h-14 w-[79rem] my-4 rounded-md font-medium text-normal text-darkColor"
                value={inputVal}
                onChange={(e) => setInputVal(e.target.value)}
              />
              <button
                onClick={submitHandler}
                className=" w-[14rem] h-[45px] bg-primaryColor  
              flex  text-lightColor relative right-[53px] 
              rounded-md justify-center items-center sm:w-[13rem] sm:right-[10rem] b "
              >
